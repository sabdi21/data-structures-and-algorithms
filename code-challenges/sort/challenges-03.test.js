...
const sortByLength = (arr) => { return arr.sort((a,b) => a.length - b.length);
}
...
const sortPeople = (arr) => {
  ...
  arr.sort( function(sortA,sortB) {
    return sortA.lastName.localeCompare(sortB.lastName);
  });
  return arr;
};
...
const sortMeetingsByDay = (arr) => {
  // Solution code here...
  const daysOfWeek = arr[0].dayOfWeek - arr[1].dayOfWeek 
};
